...
<html>
    ...
    <body>
        ...
        <hr><br>
        <a href="https://google.com" target="_blank">不判斷外部連結的外部連結</a>
        <br><br>
        包在 <font color="#ff0000">&lt;content&gt;&lt;/content&gt;</font> 內的連結 Demo
        <br>
        <content>
            <a href="https://google.com">外部連結</a> | <a href="https://example.com/test.php">內部連結</a> | <a href="test.php">內部連結 (相對路徑)</a> | <a href="">空連結</a> | <a href="javascript:;" onclick="alert('測試');">JavaScript onclick</a>
        </content>
